...
export default function Navbar() {
    ...
    return (
        <div className="mx-[2rem] flex flex-col md:flex-row bg-[#1A1A1A] text-white text-xl rounded-b-[1.25rem] md:h-[6.375rem] h-fit p-5">
            {!isSmallScreen && (
    ...
    <div className="bg-[#1A1A1A] rounded-[1.25rem] text-white flex flex-col items-start justify-between ml-0 space-y-6 z-50 mt-10 px-5">
        <Link href="/achievements">
